      ...
      <Card className="h-100 testimonial-card">
        <Card.Body>
          <div className="d-flex align-items-center">
            ...
            <Card.Img src = {data.socialIcon} className="testimonial-social-icon ms-auto align-self-start" />
          </div>
          <hr />
          {/* testimonial text starts */}
          <Card.Text className="testimonial-card-text">{data.description}</Card.Text>
